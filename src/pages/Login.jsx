                ...
                <div className="bg-white border border-slate-200 rounded-[40px] p-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)]">
                    ...
                    <div className="mt-8">
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 py-4 border border-slate-200 rounded-2xl hover:bg-slate-50 transition-all font-bold text-slate-900 group shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">
